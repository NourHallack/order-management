...
public class ProductOrderResource {
    ...
    @Autowired
    private product_orderService ProductOrderService; //the use of interface rather than class is important for loose coupling

    // Constructor based  injection
    public ProductOrderResource(product_orderService ProductOrderService) {
    ...
    public ResponseEntity getProductOrderById(@RequestParam int orderId, @RequestParam int productId) {
        ...
        try {
            Product_Order_ID productOrderId = new Product_Order_ID();
    ...
    @PostMapping
    public ResponseEntity createProductOrder(@Valid @RequestBody Product_OrderDto ProductOrderDto) {
        try {
    ...
    @PutMapping
    public ResponseEntity updateProductOrder(@Valid @RequestBody Product_OrderDto ProductOrderDto
